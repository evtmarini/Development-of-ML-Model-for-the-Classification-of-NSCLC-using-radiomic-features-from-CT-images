...
Αυτό το repository περιέχει τον πλήρη κώδικα για την ανάπτυξη ενός  ML pipeline που ταξινομεί φαινοτύπους **NSCLC και SCLC** από CT εικόνες, χρησιμοποιώντας ραδιομικά χαρακτηριστικά εξαγόμενα από αξονικές τομογραφίες (CT).
...
Το pipeline επιβεβαιώνει ότι ένα **ML workflow**,
